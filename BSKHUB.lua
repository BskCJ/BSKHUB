...
do
    local Window = Fluent:CreateWindow({
        Title = string.format("%s <b><i>%s</i></b>", string.format(MonthlyLabels[os.date("*t").month], "BskCJ Aimbot"), #Status > 0 and Status or "🔥FREE🔥"),
        SubTitle = "Created by BSKCJ",
    ...
    Tabs.Aimbot:AddParagraph({
        Title = string.format("%s 🔥FREE🔥", string.format(MonthlyLabels[os.date("*t").month], "BskCJ")),
    ...
    AimbotSection:AddButton({
        ...
        Callback = function()
            ...
            AimPartDropdown:SetValues(Configuration.AimPartDropdownValues)
            Window:Dialog({
                Title = string.format(MonthlyLabels[os.date("*t").month], "BskCJ Aimbot"),
    ...
    Tabs.Checks:AddParagraph({
        Title = string.format("%s 🔥FREE🔥", string.format(MonthlyLabels[os.date("*t").month], "BskCJ Aimbot")),
        Content = "✨BskCJ needs money $LiamMikolajek14"
    })
    ...
    PremiumChecksSection:AddParagraph({
        Title = string.format("%s 💫PREMIUM💫", string.format(MonthlyLabels[os.date("*t").month], "BskCJ Aimbot")),
        Content = "✨Upgrade to unlock all Options✨\nContact @bsk90_ via Discord to buy"
    })
    ...
    if getfenv().setclipboard then
        DiscordWikiSection:AddButton({
            ...
            Callback = function()
                getfenv().setclipboard("https://discord.gg/xUrphhDa4G")
                Window:Dialog({
                    Title = string.format(MonthlyLabels[os.date("*t").month], "BskCJ Aimbot"),
    ...
    if UISettings.ShowWarnings then
        ...
        elseif ShowWarning then
            Window:Dialog({
                Title = "Warning",
                Content = string.format("Your Software does not support all the Features of %s 🔥FREE🔥!", string.format(MonthlyLabels[os.date("*t").month], "BskCJ Aimbot")),
                Buttons = {
                    {
                        Title = "Confirm"
                    }
